...
proc edit_core {core} {
  ...
  set reg      [::ipx::add_register -quiet "p00" $addr_block]
  set_property address_offset 0x010 $reg
  set_property size           4   $reg

  set reg      [::ipx::add_register -quiet "p01" $addr_block]
  set_property address_offset 0x018 $reg
  set_property size           4   $reg

  set reg      [::ipx::add_register -quiet "p10" $addr_block]
  set_property address_offset 0x020 $reg
  set_property size           4   $reg

  set reg      [::ipx::add_register -quiet "p11" $addr_block]
